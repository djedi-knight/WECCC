...
const Home = () => (
  <article>
    <header className={style.header}>
      <div className={style.github}>
        <a className={style.donate} href='https://www.paypal.me/javivelasco' target='_blank'>
          <span className={style.legend}>Outcome Reports</span>
          <span className={style.paypal}>About</span>
          <span className={style.legend}>Contact</span>
          <span className={style.paypal}>My Community</span>
          <span className={style.legend}>My Group</span>
          <span className={style.paypal}>Sign Out</span>
        </a>
      </div>
      <h2 className={style.title}>My Groups</h2>
      <h4 className={style.subtitle}>Choose a Care Needs Group</h4>
    ...
    <section className={style.content}>
      <p>
     <section className={`${style.content}`}>
      <h3>Health Outcomes for this group:</h3>
      <ul className={style.authors}>
        <Card className={style.author}>
          <CardMedia aspectRatio='wide' image='/images/patient.png' />
          <CardTitle title="Patient Experience" subtitle="2/10" />
          <CardText>• Peer Comparison: 6/10
           • Change Over Time: Up
           </CardText>
          <CardActions>
            <Button href='http://twitter.com/javivelasco' target='_blank' className={style.twitter}><TwitterIcon /> Show Detail </Button>
          </CardActions>
        </Card>

        <Card className={style.author}>
          <CardMedia aspectRatio='wide' image='/images/quality.png' />
          <CardTitle title="Quality of Life" subtitle="7/10" />
          <CardText>• Peer Comparison: 6/10
           • Change Over Time: Up</CardText>
          <CardActions>
            <Button href='http://twitter.com/soyjavi' target='_blank' className={style.twitter}><TwitterIcon /> Show Detail</Button>
          </CardActions>
        </Card>
                <Card className={style.author}>
          <CardMedia aspectRatio='wide' image='/images/hours.jpg' />
          <CardTitle title="Hours of Care" subtitle="1.1" />
          <CardText>• Peer Comparison: 6/10
           • Change Over Time: Up</CardText>
          <CardActions>
            <Button href='http://twitter.com/soyjavi' target='_blank' className={style.twitter}><TwitterIcon /> Show Detail</Button>
                ...
                <Card className={style.author}>
          <CardMedia aspectRatio='wide' image='/images/reliance.jpg' />
          <CardTitle title="Self-Reliance" subtitle="9/10" />
          <CardText>• Peer Comparison: 6/10
           • Change Over Time: Up</CardText>
          <CardActions>
            <Button href='http://twitter.com/soyjavi' target='_blank' className={style.twitter}><TwitterIcon /> Show Detail</Button>
    ...
    Always a pleasure.
      ...
      <Link to='/components'>
        <Button label='Get healthy click here!' raised accent />
      </Link>
    </section>
